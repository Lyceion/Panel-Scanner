...
Public Class Form1
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Else
                ...
                Label3.Text = "Before Uplaod Combo List !!!"
            End If
        Catch
        End Try
    End Sub
        ...
        Try
            If sr > 0 Then
                ...
                If RadioButton3.Checked = True Then
                    ...
                    Label3.Text = "Searching Is Paused"
                    thread.Suspend()
            ...
            Else
                Label3.ForeColor = Color.FromArgb(255, 0, 0)
                Label3.Location = New Point(299, 94)
                Label3.Text = "For Pausei Before You Shold Start!"
            End If
        ...
        Try
            ...
            If sr > 0 Then
                ...
                If RadioButton3.Checked = True Then
                    ...
                    Label3.Location = New Point(299, 94)
                    Label3.Text = "Searching Is Continued"
                    thread.Resume()
                ...
                ElseIf RadioButton5.Checked = True Then
                    Label3.ForeColor = Color.FromArgb(0, 191, 255)
                    Label3.Location = New Point(299, 94)
                    Label3.Text = "Searching Is Conitnued"
                    thread.Resume()
                    thread2.Resume()
                    thread3.Resume()
                    thread4.Resume()
            ...
            Else
                Label3.ForeColor = Color.FromArgb(255, 0, 0)
                Label3.Location = New Point(299, 94)
                Label3.Text = "We Can't Continue To Not Started Work!"
            End If
        ...
        Try
            If sr > 0 Then
                ...
                If RadioButton3.Checked = True Then
                    ...
                    Label3.ForeColor = Color.FromArgb(255, 0, 0)
                    Label3.Location = New Point(299, 94)
                    Label3.Text = "Searching Is Terminated"
                    thread.Abort()
            ...
            Else
                Label3.ForeColor = Color.FromArgb(255, 0, 0)
                Label3.Location = New Point(299, 94)
                Label3.Text = "Before, Start Searching !!!"
            End If
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Try
            ...
            Else
                MsgBox("Anything To Save!", MsgBoxStyle.Critical, "ERROR!")
            End If
        Catch
        End Try
    End Sub
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Timer1.Start()
        Timer3.Start()
        TextBox29.Text = System.Text.Encoding.ASCII.GetString(spy.DownloadData("https://dl.dropbox.com/s/n3jjukoahzjs5f0/duyurueng.txt"))
    End Sub
            ...
            If TextBox23.Text = 0 And TextBox24.Text = 0 And TextBox25.Text = 0 And TextBox26.Text = 0 And TextBox27.Text = 0 Then
                ...
                If ListBox1.Items.Count.ToString() <> 0 Then
                    ...
                    Else
                        ...
                        Label3.Location = New Point(299, 94)
                        Label3.Text = "Searching Complate !!    Password Finded!"
                        TextBox1.Enabled = True
                        Button3.Enabled = False
                        Button8.Enabled = False
                        Button9.Enabled = False
                ...
                Else
                    ...
                    Else
                        ...
                        Label3.ForeColor = Color.FromArgb(255, 0, 0)
                        Label3.Location = New Point(299, 94)
                        Label3.Text = "Searching Complate !!    No Match Found :("
                        Button3.Enabled = False
                        Label6.Text = ""
                        '  sw.[Stop]()
                        ' Label5.Text = Math.Floor(sw.ElapsedMilliseconds)
    ...
    Private Sub Button4_Click_1(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Catch ex As Exception
            MsgBox("Proxy Pack Is Not Downloaded yet. Please Download In On This Button (Click Label)", MsgBoxStyle.Critical, "HATA!")
        End Try
    End Sub
